  ...
  return (
    <div className="bg-[#181818]">
      <div className="container">
        <div className="flex justify-between gap-x-8 text-gray-400 pt-7 pb-12 border-b border-[#303030] text-sm">
          {/* lists */}
          <div className="flex flex-col gap-y-2 flex-1">
            {/* title */}
            <h3 className="text-white text-[16px]">Додо Пицца</h3>
            {/* list */}
            <ul className="flex flex-col gap-y-2 ">
              <li className="hover:text-white transition-all duration-300">
                <Link href={'https://dodopizza.kz/almaty/about'}>О нас</Link>
              </li>
              <li className="hover:text-white transition-all duration-300">
          ...
          <div className="flex flex-col gap-y-2 flex-1">
            {/* title */}
            <h3 className="text-white text-[16px]">Работа</h3>
            {/* list */}
            <ul className="flex flex-col gap-y-2">
              <li className="hover:text-white transition-all duration-300">
              ...
              <li className="hover:text-white transition-all duration-300">
                <Link href={'/'}>В контакт-центре</Link>
              </li>
            </ul>
          </div>
          <div className="flex flex-col gap-y-2 flex-1">
            {/* title */}
            <h3 className="text-white text-[16px]">Партнерам</h3>
            {/* list */}
            <ul className="flex flex-col gap-y-2">
              <li className="hover:text-white transition-all duration-300">
          ...
          <div className="flex flex-col gap-y-2 flex-1">
            {/* title */}
            <h3 className="text-white text-[16px]">Это интересно</h3>
            {/* list */}
            <ul className="flex flex-col gap-y-2">
              <li className="hover:text-white transition-all duration-300">
          ...
          <div className="basis-[30%] flex flex-col items-end">
            ...
            <div className="flex gap-4 mb-4">
              ...
              >
                ...
                >
                  <g clipPath="url(#inline-svg-36-1)">
                    <path
        ...
        <div>
          <div className="text-[#BABABA] flex items-center py-6">
            ...
            <div>
              ...
              <ul className="flex gap-x-2">
                <li>
                  <Link
                    className="w-8 h-8 bg-[#303030] rounded-[5px] flex items-center justify-center"
